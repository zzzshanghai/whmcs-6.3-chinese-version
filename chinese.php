...
$_LANG['affiliatesactivate'] = "启用推广账户";
...
$_LANG['affiliatesdescription'] = "加入我们的推广计划或查看收入";
$_LANG['affiliatesdisabled'] = "我们目前未开放推广注册计划。";
$_LANG['affiliatesearn'] = "收益";
$_LANG['affiliatesearningstodate'] = "当前总收入";
$_LANG['affiliatesfootertext'] = "如果您用您的推广代码引导某人到我们的网站，那么您的推广代码将会作为 cookie 被保存在被推荐者的计算机上，如果他将我们的网站加入他的书签并且在以后某时访问我们的网站，您依然会收到佣金。";
...
$_LANG['affiliatesrealtime'] = "此处是实时统计并更新的";
...
$_LANG['announcementsdescription'] = "查看我们发布的最新消息与公告";
$_LANG['announcementsnone'] = "沒有可供查询的公告";
$_LANG['announcementsrss'] = "查看 RSS 订阅";
$_LANG['announcementstitle'] = "公告";
$_LANG['bannedbanexpires'] = "禁止到期";
$_LANG['bannedbanreason'] = "禁止原因";
$_LANG['bannedhasbeenbanned'] = "已被禁止";
$_LANG['bannedtitle'] = "IP 已封禁";
$_LANG['bannedyourip'] = "您的 IP";
$_LANG['cartaddons'] = "增值服务";
$_LANG['cartbrowse'] = "浏览产品与服务";
...
$_LANG['domaincheckerdescription'] = "檢查網域可用性";
...
$_LANG['domaincheckerintro'] = "在此處查詢您想要的網域是否可供使用，並從這裡開始您的架站體驗...";
...
$_LANG['domaincheckerinvalidtld'] = "並非有效的 TLD，請重新輸入。";
...
$_LANG['domaincheckeravailtransfer'] = "可供轉移";
$_LANG['domaincheckerenterdomain'] = "請填寫您想要註冊、轉移的網域名稱...";
$_LANG['domaincheckerbulkinvaliddomain'] = "有一筆或數筆您輸入的網域名稱並非有效值，因此已被自結果中剔除。";
